...
namespace Factory
{
    public class Case2MJConveyor : MonoBehaviour
    {
        ...
        public Case2M02[] M02List;
        public Case2M03[] M03List;
       ...
       Vector3 conveyorDir { get { return (endPoint.position - startPoint.position).normalized; } }
        ...
        private void Start()
        {
            ...
            settingView.CMachineDuration += OnOKButtonClickedDuration; //컨베이어속도
        }

        void OnOKButtonClickedDuration(float loadCapacity) // 가공시간 
        {
