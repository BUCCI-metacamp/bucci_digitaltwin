...
public class PagePopup : BaseMono<PagePopup>
{
    [SerializeField]
    UIButton btnExit;
    ...
    public void Show( string msgTitle, string msgContents, System.Action argfuncOk, System.Action argfuncFail )
    {
        funcOk = argfuncOk;
